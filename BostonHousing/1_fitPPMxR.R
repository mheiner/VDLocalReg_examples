...
# args <- c("Mean", 10, 1.0, 0.2, "NNiChisq_indep", 0.1, 1, 220729)

modtype <- as.character(args[1]) # one of "Mean", "Reg"
perc_miss = as.numeric(args[2]) # actual percent
...
(mesg = paste0("modtype", modtype, "_pMiss", perc_miss, "_alph", alph, "_sigupper", sigupper, "_simType", sim_type, "_s0_", s0, "_ii", ii, "_date", datenow))
