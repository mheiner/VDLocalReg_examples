...
# args <-  c(8, 400, 1, 230913)
p_use <- as.numeric(args[1])
n_tn <- as.numeric(args[2])
ii = as.numeric(args[3])
datenow = as.numeric(args[4])
...
save(mse, mspe, mae, mape, mld, mpld, ksd, kspd, p_use, n_tn, ii, datenow, 
     file=paste0("postsim/summary_", datname, "_competitors_p", p_use, "_n", n_tn, "_ii", ii, "_date", datenow, ".rda"))
